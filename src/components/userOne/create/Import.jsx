...
export default function Import() {
  ...
  useEffect(() => {
    const projects = axios.get('http://103.245.193.211:5001/v1/createjourney/getprojectlist')
  ...
  useLayoutEffect(() => {
    if(id!==null)
    {
      const assumption = axios.get(`http://103.245.193.211:5001/v1/createjourney/getprojectassumptions/${id}`)
      const depreication = axios.get(`http://103.245.193.211:5001/v1/createjourney/getprojectassumptionsDepreciationLife/${id}`)
      const expense = axios.get(`http://103.245.193.211:5001/v1/createjourney/getprojectassumptionsRecurrentExpenses/${id}`)
