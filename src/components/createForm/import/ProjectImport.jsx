...
export default function ProjectImport() {
    ...
    async function importAssumption(e) {
        ...
        Object.keys(depList[0]).forEach(element => {
            ...
            const assumpPromise=axios.post('http://103.245.193.211:5001/v1/createjourney/insertprojectassumptions',assumptionList, {headers});
            const depPromise=axios.post('http://103.245.193.211:5001/v1/createjourney/insertprojectassumptionsdepreciationlife',depList[0],{headers})
            const expPromise=axios.post('http://103.245.193.211:5001/v1/createjourney/insertprojectassumptionsrecurrentexpenses',JSON.stringify(expList[0]),{headers})
